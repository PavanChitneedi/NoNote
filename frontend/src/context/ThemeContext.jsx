...
export const THEMES = {
  ...
  cream: {
    ...
    vars:{
      ...
      "--canvas-dot":"#e0cebc","--node-bg":"#fffbf5","--shadow":"rgba(0,0,0,0.07)",
    },
  },
  sepia: {
  ...
  rose: {
    ...
    vars:{
      ...
      "--success":"#059669","--danger":"#dc2626",
      "--canvas-dot":"#f0c8d4","--node-bg":"#fff9fa","--shadow":"rgba(0,0,0,0.07)",
    },
  },
  softblue: {
    ...
    vars:{
      ...
      "--accent":"#2563eb","--accent2":"#1d4ed8",
      "--success":"#059669","--danger":"#dc2626",
      "--canvas-dot":"#bfdbfe","--node-bg":"#f8fbff","--shadow":"rgba(0,0,0,0.07)",
    },
  },
  mint: {
