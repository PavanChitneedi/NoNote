...
export const THEMES = {
  ...
  dark: {
    ...
    vars:{
      ...
      "--canvas-dot":"#21262d","--node-bg":"#161b22","--shadow":"rgba(0,0,0,0.5)","--neu-dark":"#05090f","--neu-light":"#444862",
    },
  },
  midnight: {
    ...
    vars:{
      ...
      "--canvas-dot":"#162035","--node-bg":"#0e1520","--shadow":"rgba(0,0,0,0.7)","--neu-dark":"#00040c","--neu-light":"#3e435f",
    },
  },
  forest: {
    ...
    vars:{
      ...
      "--success":"#73daca","--danger":"#f7768e",
      "--canvas-dot":"#162c1e","--node-bg":"#0f1c16","--shadow":"rgba(0,0,0,0.6)","--neu-dark":"#010c08","--neu-light":"#405f47",
    },
  },
  ocean: {
    ...
    vars:{
      ...
      "--canvas-dot":"#0c2040","--node-bg":"#071428","--shadow":"rgba(0,0,0,0.7)","--neu-dark":"#000310","--neu-light":"#3a4263",
    },
  },
  amber: {
    ...
    vars:{
      ...
      "--canvas-dot":"#241c0e","--node-bg":"#181208","--shadow":"rgba(0,0,0,0.7)","--neu-dark":"#060200","--neu-light":"#59413d",
    },
  },
  violet: {
    ...
    vars:{
      ...
      "--canvas-dot":"#160e30","--node-bg":"#0e0820","--shadow":"rgba(0,0,0,0.8)","--neu-dark":"#000007","--neu-light":"#523b5a",
    },
  },
  ...
  light: {
    ...
    vars:{
      ...
      "--canvas-dot":"#dde1ea","--node-bg":"#ffffff","--shadow":"rgba(0,0,0,0.08)","--neu-dark":"#c8ccd6","--neu-light":"#ffffff",
    },
  },
  cream: {
    ...
    vars:{
      ...
      "--canvas-dot":"#c8b89e","--node-bg":"#fffbf5","--shadow":"rgba(0,0,0,0.07)","--neu-dark":"#d4c8b8","--neu-light":"#fff8f0",
    },
  },
  sepia: {
    ...
    vars:{
      ...
      "--canvas-dot":"#c4a882","--node-bg":"#f9f3e8","--shadow":"rgba(0,0,0,0.09)","--neu-dark":"#cdb89a","--neu-light":"#fff8ec",
    },
  },
  rose: {
    ...
    vars:{
      ...
      "--success":"#059669","--danger":"#dc2626",
      "--canvas-dot":"#dba8b8","--node-bg":"#fff9fa","--shadow":"rgba(0,0,0,0.07)","--neu-dark":"#e0c0cc","--neu-light":"#fff4f8",
    },
  },
  softblue: {
    ...
    vars:{
      ...
      "--accent":"#2563eb","--accent2":"#1d4ed8",
      "--success":"#059669","--danger":"#dc2626",
      "--canvas-dot":"#90b8ee","--node-bg":"#f8fbff","--shadow":"rgba(0,0,0,0.07)","--neu-dark":"#b8c8dc","--neu-light":"#f0f8ff",
    },
  },
  mint: {
    ...
    vars:{
      ...
      "--canvas-dot":"#80c8a0","--node-bg":"#f8fffc","--shadow":"rgba(0,0,0,0.07)","--neu-dark":"#a8d8bc","--neu-light":"#f4fff8",
    },
  },
  clay: {
    ...
    vars:{
      ...
      "--neu-dark":"#bec7d8","--neu-light":"#f4faff",
    },
  },
    parchment: {
    ...
    vars:{
      ...
      "--canvas-dot":"#c0b09a","--node-bg":"#ffffff","--shadow":"rgba(0,0,0,0.06)","--neu-dark":"#c8baa0","--neu-light":"#ffffff",
    },
  },
};
