...
export const SKINS = {
  ...
  obsidian: {
    ...
    defaultTheme:"dark", defaultDesign:"workspace",
    accentOptions:[
...
body.skin-obsidian ::-webkit-scrollbar-thumb:hover{background:var(--text4)}`,
  ...
  aurora: {
    ...
    defaultTheme:"midnight", defaultDesign:"clean",
    accentOptions:[
...
body.skin-brutalist ::-webkit-scrollbar-thumb{background:var(--accent);border-radius:0}`,
  ...
  neonTokyo: {
    ...
    defaultTheme:"ocean", defaultDesign:"workspace",
    accentOptions:[
...
body.skin-neon-tokyo ::-webkit-scrollbar-thumb{background:var(--accent);border-radius:2px}`,
  ...
  neumorphic: {
    ...
    defaultTheme:"light", defaultDesign:"comfort",
    accentOptions:[
    ...
    vars:{
      ...
      "--shadow-node":"8px 8px 16px var(--shadow),-4px -4px 12px rgba(255,255,255,0.4)",
      "--shadow-node-sel":"6px 6px 12px var(--shadow),-4px -4px 12px rgba(255,255,255,0.5),0 0 0 3px var(--accent)44",
    ...
    css:`body.skin-neumorphic button{border:none!important;box-shadow:4px 4px 8px var(--shadow),-2px -2px 6px rgba(255,255,255,0.5)!important;transition:all 0.15s ease!important}
body.skin-neumorphic button:not([disabled]):hover{box-shadow:5px 5px 10px var(--shadow),-3px -3px 8px rgba(255,255,255,0.6)!important;transform:translateY(-1px)!important}
body.skin-neumorphic button:not([disabled]):active{box-shadow:inset 3px 3px 6px var(--shadow),inset -2px -2px 4px rgba(255,255,255,0.4)!important;transform:translateY(0)!important}
body.skin-neumorphic input,body.skin-neumorphic select,body.skin-neumorphic textarea{border:none!important;box-shadow:inset 3px 3px 6px var(--shadow),inset -2px -2px 4px rgba(255,255,255,0.5)!important}
body.skin-neumorphic input:focus,body.skin-neumorphic select:focus{box-shadow:inset 3px 3px 6px var(--shadow),inset -2px -2px 4px rgba(255,255,255,0.4),0 0 0 2px var(--accent)44!important;outline:none}
...
body.skin-neumorphic ::-webkit-scrollbar-thumb{background:var(--border);border-radius:4px}`,
  ...
  sakura: {
    ...
    defaultTheme:"cream", defaultDesign:"clean",
    accentOptions:[
...
body.skin-sakura ::-webkit-scrollbar-thumb:hover{background:var(--accent)}`,
  ...
  vapor: {
    ...
    defaultTheme:"violet", defaultDesign:"workspace",
    accentOptions:[
...
body.skin-vapor ::-webkit-scrollbar-thumb{background:var(--accent);border-radius:0}`,
  ...
  newspaper: {
    ...
    defaultTheme:"parchment", defaultDesign:"professional",
    accentOptions:[
...
body.skin-coral ::-webkit-scrollbar-thumb{background:var(--accent)55;border-radius:3px}`,
  ...
  carbon: {
    ...
    defaultTheme:"amber", defaultDesign:"workspace",
    accentOptions:[
      {name:"Amber",   accent:"#f0a830", accent2:"#c88020"},
...
body.skin-carbon ::-webkit-scrollbar-thumb{background:var(--accent);border-radius:1px}`,
  ...
  pastelPop: {
    ...
    defaultTheme:"rose", defaultDesign:"comfort",
    accentOptions:[
