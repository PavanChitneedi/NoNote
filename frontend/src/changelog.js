...
export const CHANGELOG = [
  {v:"v5.27.1",date:"Apr 2026",items:["Build fix: restored all missing closing braces from />} replacement — showTutorial, showHelp, notes indicator, modal conditionals, arrow heads, fragment blocks"]},
